#include "PDBInterfaceWithPolarH.h"
#include <iostream>
#include <fstream>
#include <vector>
#include <stdio.h>
...
PDBInterfaceWithPolarH::PDBInterfaceWithPolarH()
{
	pItsEnsemble = 0;
}

PDBInterfaceWithPolarH::PDBInterfaceWithPolarH(const string& _filename)
...
PDBInterfaceWithPolarH::PDBInterfaceWithPolarH(const PDBInterface& _other)
{
	pItsEnsemble = 0;
}
...
void PDBInterfaceWithPolarH::readData(ifstream& _infile)
{
	string linebuffer;
...
void PDBInterfaceWithPolarH::categorizeLines()
{
	string header;
...
void PDBInterfaceWithPolarH::parseAtomLine()
{	
	...
	residue::setupDataBase(false,true);
...
// means i didn't find it!
*/
void PDBInterfaceWithPolarH::parseBIOMT()
{
