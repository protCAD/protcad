...
int main (int argc, char* argv[])
{
	...
	cout << "\n----------- testing dead end elimination -------------\n";
	deadEndEliminator* pEliminator = new deadEndEliminator(pTheProtein);
	pEliminator->run(3, 100000);
	cout << "\n-------- ending test of dead end elimination ---------\n";
