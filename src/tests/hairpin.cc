...
int main (int argc, char* argv[])
{
	...
	pTheProtein->activateForRepacking(0, pTheProtein->getIndexFromResNum(0,1));
    pTheProtein->activateForRepacking(0, pTheProtein->getIndexFromResNum(0,2));
	...
	pTheProtein->setOnlyROCHydrophobic(0, pTheProtein->getIndexFromResNum(0,1));
    pTheProtein->setOnlyROCHydrophobic(0, pTheProtein->getIndexFromResNum(0,2));
    pTheProtein->setOnlyROCHydrophobic(0, pTheProtein->getIndexFromResNum(0,5));
    pTheProtein->setOnlyROCHydrophobic(0, pTheProtein->getIndexFromResNum(0,10));
